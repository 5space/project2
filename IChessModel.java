...
public interface IChessModel {
	 ...
	 *
	 * @param move a {@link W18project3.Move}
	 * object describing the move to be made.
	 * @return {@code true} if the proposed move is valid,
	 * {@code false} otherwise.
	 * @throws IndexOutOfBoundsException if either
	 * {@code [move.fromRow, move.fromColumn]} or {@code [move.toRow,
	 * move.toColumn]}
	...
	/**
	 * Moves the piece from location {@code
	 * [move.fromRow, move.fromColumn]} to location
	 * {@code [move.fromRow,move.fromColumn]}.
	 * @param move a {@link project2.Move}
	 *                object describing the move to be made.
	 * @throws IndexOutOfBoundsException
	 * if either {@code [move.fromRow, move.fromColumn]}
	 * or {@code [move.toRow,
	 ...
	 * @return {@code true}
	 * if the current player is in check, {@code false} otherwise.
	 */
